...
<body>
	...
	<section>
		<h2>홈쇼핑 회원 정보 수정</h2>
		<%-- 이 예제는 el ${}을 사용해서 값을 출력하고자 일반변수 dto로는 할 수 없으므로
			 자바빈을 만든 후에 자바빈 객체에 dto의 각 필드값을 전달한 것이다.
			 =>매우 비효율적. 그래서 forward 로 해결해 보기.
		 --%>
		...
		<form action="UpdateSave.jsp" method="post">
			<table>
				<tr>
					...
					<td><input type="text" id="lblNum" value="${param.custno }"
						 disabled="disabled"> 
